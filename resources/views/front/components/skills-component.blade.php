    ...
    <div class="container py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                @if(count($skills) > 0)
                    @php
                        $bg = ['bg-primary', 'bg-secondary', 'bg-dark', 'bg-danger', 'bg-info', 'bg-gradient' ];
                        $counter = 0;
                    @endphp
                    @foreach($skills as $skill)
                        <div class="skill mb-4">
                            ...
                            <div class="progress">
                                <div class="progress-bar {{ $bg[$counter % count($bg)] }}" role="progressbar" aria-valuenow="{{ $skill->progress }}"
                                     aria-valuemin="0"
